...
!$omp parallel do reduction(+: CXSCL1,CXSCL2,CXSCL3)
         ...
         PRINT *, 'CXSCL n-1 is:'
         PRINT *, CXSCL1, CXSCL2, CXSCL3
         PRINT *, 'CXE(1) is:'
         PRINT *, CXE(1,1), CXE(1,2), CXE(1,3)
         PRINT *, 'CXP(1) is:'
         PRINT *, CXP(1,1), CXP(1,2), CXP(1,3)
         PRINT *, 'SCRRS1(1) is:'
         PRINT *, SCRRS1(1,1), SCRRS1(1,2), SCRRS1(1,3)
         PRINT *, 'CXSCR1(1) is:'
         PRINT *, CXSCR1(1)
...
! fields (in lab frame), expressed as a cross section:
         ...
         !Diagnostics added by NWB 7/3/12
         PRINT *,'AK is:'
         PRINT *, AK(1), AK(2), AK(3)
         PRINT *, 'CXSCL final is:'
         PRINT *, CXSCL1, CXSCL2, CXSCL3
