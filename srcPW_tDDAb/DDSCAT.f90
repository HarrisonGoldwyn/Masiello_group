...
! Local variables:
      ...
      REAL(WP) :: AEFF,AK1,AK3,BETAD,BETAMI,BETAMX,BETMID,BETMXD,COSBET,      &
                  ...
                  THTMID,THTMXD,TOL,WAVE,XMAX,XMIN,XX,YMAX,YMIN,ZMAX,ZMIN,NBACK
...
!***
            ...
            AEFF=AEFFA(IRAD)
            XX=2._WP*PI*AEFF*NBACK/WAVE ! Background index added by SCQ 7/30/2017
...
! Added by SCQ 31 July 2017
!************ tDDA Parameter File **************
!      OPEN(929,file='var.par',status='replace')
!      write(929,'(A)') 'num_k: 1'
!      write(929,'(A)') 'k_out: 0.6'
!      write(929,'(A)') 'k_in: 314'
!      write(929,'(A,F6.4,A)') 'lambda:',WAVE,'e-06'
!      write(929,'(A,F6.3)') 'n_m:',NBACK
!      write(929,'(A)') 'I_0: 1e+9'
!      write(929,'(A)') 'unit: 1.0'
!      write(929,*)
!      write(929,'(A)') 'd: 1'
!      write(929,'(A,I4)') 'x_min: ', FLOOR(XMIN -9)
!      write(929,'(A,I3)') 'x_max: ', FLOOR(XMAX +10)
!      write(929,'(A,I4)') 'y_min: ', FLOOR(YMIN -9)
!      write(929,'(A,I3)') 'y_max: ', FLOOR(YMAX +10)
!      write(929,'(A,I4)') 'z_min: ', FLOOR(ZMIN -9)
!      write(929,'(A,I3)') 'z_max: ', FLOOR(ZMAX +10)
!      close(929)
!************************************************
