...
!*** First compute Clausius-Mossotti polarizability:
                  ...
                  CXTERM=(.75_WP/PI)*(CXEPS(IC)-1_WP*NBACK**2)/(CXEPS(IC)+2_WP*NBACK**2)
...
!*** First compute Clausius-Mossotti polarizability:
                  ...
                  CXTERM=(.75_WP/PI)*(CXEPS(IC)-1_WP*NBACK)/(CXEPS(IC)+2_WP*NBACK**2)
